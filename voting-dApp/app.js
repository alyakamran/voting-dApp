...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    function scrollToVoteSection() {
        document.getElementById('voteBtt').scrollIntoView({ behavior: 'smooth' });
    }

    let isVoteSectionVisible = false;
    let areResultsVisible = false;
    let isAdminSectionVisible = false;

    document.getElementById('voteBtt').addEventListener('click', function() {
        // Toggle the visibility of the voteSection
        isVoteSectionVisible = !isVoteSectionVisible;
        document.getElementById('voteSection').style.display = isVoteSectionVisible ? 'block' : 'none';
    });

    document.getElementById('resBtt').addEventListener('click', function() {
        // Toggle the visibility of the results section
        areResultsVisible = !areResultsVisible;
        document.getElementById('results').style.display = areResultsVisible ? 'block' : 'none';
    });

    document.getElementById('adminBtt').addEventListener('click', function() {
        // Toggle the visibility of the adminSection
        isAdminSectionVisible = !isAdminSectionVisible;
        document.getElementById('adminSection').style.display = isAdminSectionVisible ? 'block' : 'none';
    });
